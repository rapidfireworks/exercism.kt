...
class BinarySearchTest {
  ...
  @Test
  fun `finds value in array with one element`() = assertEquals(0, BinarySearch.search(listOf(6), 6))

  @Test
  fun `finds value in the middle of array`() = assertEquals(3, BinarySearch.search(listOf(1, 3, 4, 6, 8, 9, 11), 6))

  @Test
  fun `finds value at the beginning of array`() = assertEquals(0, BinarySearch.search(listOf(1, 3, 4, 6, 8, 9, 11), 1))

  @Test
  fun `finds value at the end of array`() = assertEquals(6, BinarySearch.search(listOf(1, 3, 4, 6, 8, 9, 11), 11))
